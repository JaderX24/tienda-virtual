...
export class CrearEmpresaDto {
    ...
    @ApiProperty({ description: 'RTN de la empresa (formato XXXX-XXXX-XXXXXX)' })
    ...
    @ApiProperty({ description: 'Tipo de negocio', enum: TIPOS_NEGOCIO })
    @IsString({ message: 'El tipo de negocio debe ser texto' })
    @IsNotEmpty({ message: 'El tipo de negocio es obligatorio' })
    ...
    @ApiProperty({ description: 'Departamento o estado' })
