...
export class FiltroCategoriaDto {
    ...
    @ApiPropertyOptional({ description: 'Filtrar solo categorías raíz (sin padre)' })
    @IsOptional()
    @IsBoolean({ message: 'El filtro de raíz debe ser verdadero o falso' })
    @Type(() => Boolean)
    soloRaiz?: boolean;
