...
export class TiendasService {
    ...
    private mapearATienda(empresa: any) {
        return {
            ...
            planSuscripcion: empresa.planSuscripcion || null,
            moneda: empresa.moneda || null,
            zonaHoraria: empresa.zonaHoraria || null,
    ...
    async crear(datos: any) {
        ...
        const empresa = await this.prisma.empresa.create({
            data: {
                ...
                pais: datos.ubicacion?.pais || null,
                ...
                planSuscripcion: datos.planSuscripcion || null,
