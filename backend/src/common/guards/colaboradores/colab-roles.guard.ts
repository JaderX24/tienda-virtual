...
import { COLAB_ROLES_KEY } from '../../decorators/colaboradores/colab-roles.decorator';

@Injectable()
export class ColabRolesGuard implements CanActivate {
    constructor(private reflector: Reflector) {}

    canActivate(context: ExecutionContext): boolean {
        const rolesRequeridos = this.reflector.getAllAndOverride<string[]>(COLAB_ROLES_KEY, [
            context.getHandler(),
            context.getClass(),
        ]);
